...
angular.module('evtrs-site')
    ...
    .constant('PROJECT_CONSTANTS', {
        'ocean-feedr': {bgColor: '#dcdcdc', image: {src: 'assets/images/ocean-feedr/ocean-feedr.png'}, outerHeight: '70vh', position:'left', siteUrl: 'http://oceanfeedr.herokuapp.com', sourceUrl: 'https://github.com/eventures-io/ocean-feedr'},
        polaroiz: {bgColor: '#dcdcdc', image: {src: 'assets/images/polaroiz/polaroiz.png'}, outerHeight: '76vh', position:'left', siteUrl: 'http://polaroiz.herokuapp.com', sourceUrl: 'https://github.com/eventures-io/polaroiz'},
        ...
        plantzr: {bgColor: '#dcdcdc', image: {src: 'assets/images/plantzr/plantzr.png'}, outerHeight: '80vh', position:'right',siteUrl: 'http://plantzr.herokuapp.com', sourceUrl: 'https://github.com/eventures-io/plantzr'},
